...
exports = module.exports = function (server, opts) {
	...
	var socket = createSocket(toHTTPServer(server), opts.of);
...
/**
 * Ensure we have an instance of http.Server
 */
function toHTTPServer(server) {
	server = server || 8080;
...
/**
 * HTTP request handler to serve static content
 */
