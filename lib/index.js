...
Server.prototype.createEmitter = function (emitter) {
	return factories[emitter].apply(this, Array.prototype.slice.call(arguments, 1));
};

Server.prototype.use = function (emitter) {
	this.listen(this.createEmitter.apply(this, arguments));
	return this;
}
